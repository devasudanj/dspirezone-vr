/**
 * src/screens/SessionContactScreen.tsx
 * ----------------------------------
    ...
    >
      <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>
            We’ll save your contact details for this session before you begin.
          </Text>
        </View>
      ...
      <View style={styles.footer}>
        <TouchableOpacity
          ...
          accessibilityLabel="Continue to session duration selection"
        >
          {submitting ? (
